...
export function TimeToOverdue({ expirationDate }: TimeToOverdueProps) {
  ...
  return (
    <Container className="absolute top-20 left-5 w-[400px] flex p-1 justify-center gap-1 border-2 rounded-md bg-white bg-opacity-50 border-red-700 text-center text-red-700 font-bold">
