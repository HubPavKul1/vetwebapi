  ...
  return (
    <Container className={styles.pdfBody}>
      ...
      <Row>
        ...
        <Col className={styles.underScored}>{companyDoctor}</Col>
      </Row>
      <Row>
        <Col sm={3}></Col>
      ...
      <Row >
        ...
        <Col sm={3} className={styles.underScored}>
          {animals}
        </Col>
        <Col>против</Col>
        <Col sm={3} className={styles.underScored}>
      ...
      <Row>
        ...
        <Col sm={4} className={styles.underScored}>
      ...
      <Row>
        ...
        <Col>в дозе</Col>
        <Col sm={7} className={styles.underScored}>
          {data.drug.drug_dosage}
        </Col>
      </Row>
      <Row>
        <Col>место инъекции дезинфицировали</Col>
        <Col sm={8} className={styles.underScored}>
          70% этиловым спиртом
        </Col>
      </Row>
      <Row>
      ...
      <Row>
        <Col className={styles.actText}>
          Для проведения обработки израсходовано:
        </Col>
      </Row>
      <Row>
        <Col sm={3}>1. Препарата</Col>
        <Col sm={6} className={styles.underScored}>
          {data.drug.name}
        </Col>
