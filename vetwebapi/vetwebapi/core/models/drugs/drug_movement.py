...
class DrugMovement(Base):
    ...
    # Ассоциация с Drug
    catalog_drugs: Mapped[list["CatalogDrug"]] = relationship(back_populates="drug_movements", secondary="drugs_in_movement")
    catalog_drugs_details: Mapped[list["DrugInMovement"]] = relationship(back_populates="drug_movement")
