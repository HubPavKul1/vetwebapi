...
class CatalogDrug(Base):
    ...
    drug_movements: Mapped[list["DrugMovement"]] = relationship(back_populates="catalog_drugs", secondary="drugs_in_movement")
    drug_movements_details: Mapped[list["DrugInMovement"]] = relationship(back_populates="catalog_drug")
