...
# from vetwebapi.api_v1.users import crud
from core.settings import settings
from core.models.base import Base
from core.database import DBManager, db_manager, db_url
from main import app

test_db_manager = DBManager(url=db_url, echo=settings.db_echo)
url = db_url
...
# async def add_users(ac: AsyncClient, prepare_db):
#     async with test_db_manager.async_session_factory() as session:
#         await crud.create_users(session=session)
